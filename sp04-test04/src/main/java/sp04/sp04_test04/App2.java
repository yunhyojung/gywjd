...
public class App2 { //자바로 회원관리하는 방법 알아보기(실제로 사용하지는 않음)-dependencies
	private static GenericXmlApplicationContext ctx;
	
	
     public static void main(String[] args) { //main메소드 : ***컨트롤러 부분이라 생각하면 됨***
//    	 String [] conf = {"classpath:appCtx1.xml", "classpath:appCtx2.xml"}; 배열
    	 String [] conf = {"classpath:appCtx2.xml"};  //import사용
