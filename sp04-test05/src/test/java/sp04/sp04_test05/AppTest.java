...
import sp04.sp04_test05.service.ChangePasswordService;
import sp04.sp04_test05.service.MemberInfoPrinter;
import sp04.sp04_test05.service.MemberListPrinter;
import sp04.sp04_test05.service.MemberRegisterService;
...
//		MemberRegisterService mrs = new MemberRegisterService(memberDAO); //의존객체(dependency object)
				MemberRegisterService mrs = ctx.getBean("memberRegisterService", MemberRegisterService.class); // appCtx에
																												// 있는
																												// id값
				mrs.regist(req);
